...
<head>
    ...
    <title>Update Vehicle Profile - Mega City Cab Service</title>
    <!-- Bootstrap CSS -->
...
<!-- Hero Section -->
<div class="hero">
    <h1>Update Vehicle Profile</h1>
    <p>Fill out the form below to update the vehicle profile in Mega City Cab Service</p>
</div>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="vup">
                        <div class="mb-3">
                            ...
                            <select id="options" name="vehicle" class="form-control">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="brand_model" placeholder="Brand & Model">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="chassis_no" placeholder="Chassis Number">
                        </div>
