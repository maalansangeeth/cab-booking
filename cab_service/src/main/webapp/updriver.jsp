...
<head>
    ...
    <title>Update Driver Profile - Mega City Cab Service</title>
    <!-- Bootstrap CSS -->
...
<div class="hero">
    ...
    <p>Fill out the form below to update the driver profile in Mega City Cab Service</p>
</div>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="driverup">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="driver_id" placeholder="Driver ID">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="contact_no" placeholder="Contact Number">
                        </div>
