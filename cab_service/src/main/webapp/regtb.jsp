...
<div class="container mt-4">
    <c:if test="${empty cust}">
        <p class="alert alert-warning text-center">No customers found in the database.</p>
    </c:if>
            ...
            <tbody>
                <c:forEach var="cus" items="${cust}">
                    <tr>
                        ...
                        <td>${cus.password}</td>
                        <td>
                            <form action="delreg" method="post" class="d-inline">
                                <input type="hidden" name="reg_no" value="${cus.reg_no}">
